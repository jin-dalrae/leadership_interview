...
import { ClosingArtBackground } from './ClosingArtBackground'

export function ClosingSummary() {
  return (
    <>
      <section id={CLOSING_SUMMARY.id} className="closing-art-visual">
        <ClosingArtBackground />
      </section>
      <section className="closing-summary-spin">
        <div className="spinning-square" aria-hidden="true" />
        <div className="closing-summary__content">
